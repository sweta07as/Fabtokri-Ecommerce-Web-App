  ...
  return (
    <div className="para">
      ...
      <p>
        ...
        of your information, at any time, by contacting us at info@fabtokri.com
        or mailing us at: fabtokri B-224/A, Rama Par Road, Mohan Garden, Uttam
        Nagar, Delhi-110059
      </p>
      ...
      <p>
        ...
        Phonepe stores your credit card data. It is encrypted through the
      ...
      <p>
        ...
        Our store uses Google Analytics to help us learn about who visits our
      ...
      <p>
        We utilize cookies on specific pages of the Platform to analyze webpage
        flow, evaluate promotional effectiveness, and enhance trust and safety.
        These cookies are small files stored on your hard drive that aid in
        providing our services. They do not contain personal information. Some
        features on the Platform require cookies, and they can help tailor
        information based on your interests. Most cookies are "session cookies,"
        deleted automatically at the end of a session. You can decline/delete
        our cookies, but certain features may be unavailable, and password
        re-entry may be more frequent. Third-party partners like Google
        Analytics may also use cookies for marketing and analytical purposes.
      </p>
      ...
      <p>
        ...
        information contact our Privacy Compliance Officer at fabtokri@gmail.com
        or by mail at fabtokri
        <br />
        <br />
        {/* [Re: Privacy Compliance Officer] */}
        {/* <br /> */}
        {/* <br /> */}
        B-224/A, Rama Park Road, Mohan Garden, Uttam Nagar, Near Himachal
        Sweets, Delhi-110059
      </p>
    </div>
  );
